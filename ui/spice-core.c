...
{
    .qemu_is_using_spice           = qemu_is_using_spice,
    .qemu_start_using_spice        = qemu_start_using_spice,
    .qemu_spice_init               = qemu_spice_init,
    .qemu_spice_display_init       = qemu_spice_display_init,
    .qemu_spice_display_add_client = qemu_spice_display_add_client,
    .qemu_spice_set_passwd         = qemu_spice_set_passwd,
    .qemu_spice_set_pw_expire      = qemu_spice_set_pw_expire,
    .qemu_spice_migrate_info       = qemu_spice_migrate_info,
    .qemu_spice_query              = qemu_spice_query,
};
